      ...
      <div class="hero-visual-wrap">
        <div class="workspace-3d" aria-hidden="true">
          ...
          <div class="ws-body">
            ...
            <pre class="ws-editor"><span class="cm">-- ForgeLab · live workspace</span>
...
kubectl apply -f deploy.yaml</pre>
  ...
  function viewHome() {
    ...
    return `
      <section class="hero">
        ...
        <div class="hero-grid">
          <div class="hero-copy">
            <div class="eyebrow">Premium developer academy</div>
  ...
  function viewProjects() {
    return `
      <div class="page">
        ...
        <p class="lead">Ship these end-to-end. Each maps to skills from ForgeLab courses.</p>
        <div class="projects-grid">
          ${M.projects.map((p) => `
            <article class="project-card">
              <span class="tag">${p.tag}</span>
    ...
    return `
      <div class="page">
        ...
        <div class="features-grid">
          ...
          <article class="feature-card"><div class="feature-icon">📺</div><h3>YouTube</h3><p>Walkthroughs that mirror ForgeLab lesson flows.</p><a class="btn btn-ghost btn-sm" style="margin-top:1rem" href="https://youtube.com" target="_blank" rel="noopener">Watch</a></article>
  ...
  function viewAuth(mode) {
    ...
    return `
      <div class="auth-panel">
        ...
        <p class="lead">${isLogin ? "Log in to continue your ForgeLab progress." : "Create your ForgeLab account and start your first path today."}</p>
  ...
  function viewLegal(kind) {
    return `
      <div class="page">
        ...
        <p class="lead">ForgeLab stores lesson progress locally in your browser unless you create an account. We don’t sell personal data. This is a demo legal stub — replace with counsel-approved policies before production launch.</p>
  ...
  function viewNotFound() {
    return `<div class="page"><h1>Not found</h1><p class="lead">That page isn’t in ForgeLab.</p><a class="btn btn-primary" href="#/" data-nav>Home</a></div>`;
  }
